                                            ...
                                            <div class="box">
                                                <div class="box-body">
                                                    <form method="post" autocomplete="on" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4" for="last-name">Series</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select name="moa" class="select2_single form-control" tabindex="-1" required="required">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="file" name="fileUpload" id="file" required="required" class="form-control col-md-7 col-xs-12" accept=".pdf">
                                                    ...
                                                    if (isset($_POST['submit'])) {
                                                        ...
                                                        $chk = mysqli_query($con, "SELECT * FROM ebook WHERE accession_no = '" . $accession_no . "' ");
                                                        $ct = mysqli_num_rows($chk);

                                                        if ($ct == 0) {

                                                            mysqli_query($con, "INSERT INTO ebook (call_no,title,subject,author,editor,edition,pop_id,publisher_id,quantity,date_of_publ,series,isbn_no,accession_no,moa_id,issn_no,notation1,notation2,abstract,remarks,page_no, file)
