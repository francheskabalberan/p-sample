...
if ($_SESSION['role'] == "Administrator") {
  echo '
        ...
        <li class="header" style="color: white">E-BOOKS & BOOK MAINTENANCE</li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-book"></i>
            <span>E-Books & Books</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <li><a href="arc_in_ebook.php"><i class="fa fa-book"></i> <span>Inactive E-Books</span></a></li>
  ...
  echo '
        ...
        <li>
          <a href="search_ebook.php">
            <i class="fa fa-home"></i> <span>Search E-Book</span>
          </a>
        </li>
        ...
        <li>
        <a href="user_ebook.php"><i class="fa fa-book"></i> <span>E-Book List</span></a>
      </li>
