                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form method="GET" class="form-horizontal">
                            <center>
                                <h3><strong>Search Inactive E-Books</strong></h3>
                            </center>
                        ...
                        <table s id="example1" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['submit'])) {
                                    ...
                                    $return_query = mysqli_query($con, "SELECT * from e_archieve 
        LEFT JOIN tbl_moa ON tbl_moa.moa_id = e_archieve.moa_id
        LEFT JOIN tbl_publishers ON tbl_publishers.publisher_id = e_archieve.publisher_id
        LEFT JOIN tbl_placeofpublications ON tbl_placeofpublications.pop_id = e_archieve.pop_id
        where call_no LIKE '%$_GET[search]%' or title LIKE '%$_GET[search]%' or subject LIKE '%$_GET[search]%' or author LIKE '%$_GET[search]%' or accession_no LIKE '%$_GET[search]%' or remarks LIKE '%$_GET[search]%' ") or die(mysqli_error($con));
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <?php if ($_SESSION['role'] == "Administrator") { ?>
                                                <td>
                                                    <a class="btn btn-default" for="ViewAdmin" href="view_ebook.php<?php echo '?ebook_id=' . $id; ?>">
                                                        <i class="fa fa-eye"></i> View
                                                    </a>
                                                    <a class="btn btn-success" for="ViewAdmin" href="restore_ebook.php<?php echo '?ebook_id=' . $id; ?>">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="del_arc_ebook.php<?php echo '?ebook_id=' . $id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
