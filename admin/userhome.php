                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <?php
                                            $result = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(quantity) as total FROM `ebook`")) or die(mysqli_error($con));
                                            ?>
                                            <div class="huge"><?php echo $result['total']; ?></div>
                                            <div>Total<br> E-Books</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="user_ebook.php">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
                            ...
                            <div class="panel panel-danger">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <?php
                                            $count1 = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) as total FROM `borrow_book` WHERE `borrowed_status` = 'borrowed' AND user_id = '$id_session'")) or die(mysqli_error($con));
                                            ?>
