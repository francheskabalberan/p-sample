                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <?php
                                $query = mysqli_query($con, "select * from ebook where ebook_id='$get_id'") or die(mysqli_error($con));
                                  ...
                                  where ebook_id='$get_id'") or die(mysqli_error($con));
                                        ...
                                        if (isset($_POST['update'])) {
                                            ...
                                            $date = date('Y-m-d'); {
                                                ...
                                                mysqli_query($con, " INSERT INTO e_archieve (ebook_id,call_no,title,subject,author,editor,edition,pop_id,publisher_id,quantity,date_of_publ,series,isbn_no,accession_no,moa_id,issn_no,notation1,notation2,abstract,remarks,page_no,deyt) VALUES ('$ebook_id','$call_no','$title','$subject','$author','$editor','$edition','$place_of_publ','$publisher','$quantity','$date_of_publ','$series','$isbn_no','$accession_no','$moa','$issn_no','$notation1','$notation2','$abstract','$remark','$page_no','$date') ") or die(mysqli_error($con));
