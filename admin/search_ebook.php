                        ...
                        <table s id="example1" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['submit'])) {
                                    ...
                                    $return_query = mysqli_query($con, "SELECT * from ebook
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-default" href="view_ebook.php?ebook_id=<?php echo $id; ?>" target="_blank">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 style="font-weight: bold" class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-user"></i>
                                                                        Delete Book</h4>
                                                                </div>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button class="btn btn-inverse" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove icon-white"></i>
                                                                            No</button>
                                                                        <a href="delete_ebook.php<?php echo '?ebook_id=' . $id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i>
                                                                            Yes</a>
                                                                    </div>
                                                                </div>
                                                            </div>
