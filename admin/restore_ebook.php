                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <?php
                                $query = mysqli_query($con, "select * from e_archieve where archive_id='$get_id'") or die(mysqli_error($con));
                                $row = mysqli_fetch_array($query);
                                ?>
                                <div class="box">
                                    <div class="box-body">
                                        <center>
                                            <h3><strong>You are about to send this lists into "ACTIVE STATUS" </h3>
                                        </center><br>
                                        ...
                                        <form method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to mark this as ACTIVE?');" class="form-horizontal form-label-left">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input type="hidden" name="ebook_id" id="last-name2" value="<?php echo $row['ebook_id']; ?>" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            ...
                                            <?php
                                            $query1 = mysqli_query($con, "SELECT * FROM e_archieve
                                  LEFT JOIN tbl_placeofpublications ON e_archieve.pop_id = tbl_placeofpublications.pop_id
                                  LEFT JOIN tbl_publishers ON e_archieve.publisher_id = tbl_publishers.publisher_id
                                  LEFT JOIN tbl_moa ON e_archieve.moa_id = tbl_moa.moa_id 
                                  ...
                                  where archive_id='$get_id'") or die(mysqli_error($con));
                                        ...
                                        if (isset($_POST['update'])) {
                                            ...
                                            $page_no = $_POST['page_no']; {
                                                ...
                                                mysqli_query($con, " INSERT INTO ebook (call_no,title,subject,author,editor,edition,pop_id,publisher_id,quantity,date_of_publ,series,isbn_no,accession_no,moa_id,issn_no,notation1,notation2,abstract,remarks,page_no) VALUES ('$call_no','$title','$subject','$author','$editor','$edition','$place_of_publ','$publisher','$quantity','$date_of_publ','$series','$isbn_no','$accession_no','$moa','$issn_no','$notation1','$notation2','$abstract','$remark', '$page_no') ") or die(mysqli_error($con));
